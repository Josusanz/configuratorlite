...
;(function($, window, document, undefined){
	...
	$.pixMediaInsert.prototype = {
		...
		insertSavedItems:function() {
			var self = this, 
				con = self.$el.parent('.media-upload-input-wrap'),
				value = con.find('.media-upload-val').val(),
			 	savedItems = (value) ? $.parseJSON( value ) : [],
		...
		saveData:function(){
			var self= this,
				...
				$wrap = con.closest('.media-upload-input-wrap');
				
			$wrap.find('.media-upload-val').val(JSON.stringify(self.selectedUrl));
		},
