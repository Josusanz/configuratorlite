 ...
 *
 * For WPC_Emogrifier 3.0.0, this will be the successor to the \WPCPelago\WPC_Emogrifier class (which then will be deprecated).
 *
 ...
 */
class WPC_CssInliner extends WPC_AbstractHtmlProcessor
{
    /**
     * @var int
     */
