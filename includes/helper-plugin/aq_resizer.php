...
if ( ! class_exists( 'WPC_Aq_Resize' ) ) {
	class WPC_Aq_Resize {
		...
		/**
		 * For your custom default usage you may want to initialize an WPC_Aq_Resize object by yourself and then have own defaults
		 */
...
if ( ! function_exists( 'wpc_aq_resize' ) ) {

	/**
	 * This is just a tiny wrapper function for the class above so that there is no
	 * need to change any code in your own WP themes. Usage is still the same :)
	 */
	function wpc_aq_resize( $url, $width = null, $height = null, $crop = null, $single = true, $upscale = false ) {
		$wpc_aq_resize = WPC_Aq_Resize::getInstance();
		return $wpc_aq_resize->process( $url, $width, $height, $crop, $single, $upscale );
	}
}
